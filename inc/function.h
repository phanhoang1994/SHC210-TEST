...
#define X1_ON()		GPIOPinWrite(GPIO_PORTA_BASE, GPIO_PIN_7, GPIO_PIN_7)
#define LTD_ON()	GPIOPinWrite(GPIO_PORTA_BASE, GPIO_PIN_5, GPIO_PIN_5)
#define LTU_ON()	GPIOPinWrite(GPIO_PORTA_BASE, GPIO_PIN_3, GPIO_PIN_3)

#define X1_OFF()	GPIOPinWrite(GPIO_PORTA_BASE, GPIO_PIN_7, 0)
#define LTD_OFF()	GPIOPinWrite(GPIO_PORTA_BASE, GPIO_PIN_5, 0)
#define LTU_OFF()	GPIOPinWrite(GPIO_PORTA_BASE, GPIO_PIN_3, 0)
