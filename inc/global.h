...
#define TR_UPDATE0				300
#define TR_UPDATE1				300
#define TR_HOLDING_1		10
...
#if (JAPANESE == 0)
	#define NUMBER_SPEED	40
	#define ARROW_SPEED		40
	#define STRING_SPEED	35
#else
	#define NUMBER_SPEED	45
	#define ARROW_SPEED		90
